  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(children: <Widget>[
        (Column(children: [
          buildTextField(Icons.search, "Search...", false, false, '',
                      ...
                      children: <Widget>[
                        ...
                        SafeArea(
                          child: setting(catigorie, title, description, date,
                              id, isChecked, index, color, location),
                        ),
                      ],
                    ),
                    Row(
...
//FlutterClipboard.copy(item.code).then((value) {})
  ...
  _showAddDialog(ctx, date, id, catigorie, title, description, color, location,
      isChecked) async {
    await showDialog(
        barrierColor: Colors.black12,
        context: context,
...
Widget buildTextField(IconData icon, String hintText, bool isPassword,
    bool isEmail, String msg, TextEditingController controller, context) {
  return Padding(
